...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-bg-dark-2 pt-16 pb-8">
      {/* Línea gradiente teal en borde superior */}
      <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-teal-accent/40 to-transparent" aria-hidden="true" />
