          ...
          <div className="col-span-1 lg:col-span-7 relative min-h-[440px]">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="h-full"
              >
                <CardTilt className="card-neon-border h-full flex flex-col gap-6 p-8 md:p-10 rounded-[var(--r-xl)] bg-bg-card/80 backdrop-blur-sm relative overflow-hidden group">
