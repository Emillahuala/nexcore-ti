...
const inputClass =
  'form-input w-full bg-white/[.04] border border-[rgba(200,205,212,.14)] rounded-xl text-white text-[0.9375rem] px-4 py-3 outline-none transition-all focus:border-teal-accent focus:shadow-[0_0_0_3px_rgba(110,207,209,.18)] placeholder:text-[#8A919A]'

const selectClass =
  'form-select w-full border border-[rgba(200,205,212,.14)] rounded-xl text-white text-[0.9375rem] px-4 py-3 outline-none transition-all focus:border-teal-accent focus:shadow-[0_0_0_3px_rgba(110,207,209,.18)]'
      ...
      <div className="section-container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <motion.div
            ...
            className="card-neon-border bg-bg-card/80 backdrop-blur-sm rounded-[var(--r-xl)] p-8"
          >
            <form onSubmit={handleSubmit(onSubmit)} noValidate aria-label="Formulario de contacto">
              ...
              <div className="mb-5">
                ...
                <select id="service" className={`${selectClass} ${errors.service ? 'border-red-400' : ''}`} {...register('service')}>
