  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" aria-hidden="true" style={{ pointerEvents: 'none', backgroundColor: '#000000' }}>
        ...
        />
        {/* Centro radial — enfoca atención en el contenido */}
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background: 'radial-gradient(ellipse 55% 60% at 30% 50%, rgba(46,138,208,.10) 0%, transparent 70%)',
            zIndex: 5,
          }}
        />
      </div>
        ...
        <div className="flex items-center gap-16">
          ...
          <div className="flex-1 max-w-[620px]">
            ...
            <motion.div {...fadeUp(0.3)} className="flex flex-wrap gap-4 mb-14">
              <a
                href="#contact"
                className="btn-shimmer inline-flex items-center gap-2 px-8 py-[15px] rounded-full text-base font-semibold text-white bg-grad-brand shadow-brand hover:-translate-y-0.5 hover:shadow-glow transition-all no-underline"
              >
                {HERO.ctaPrimary}
